...
def delete_lines(file_path, lines_to_delete="1-134"):
    """TXT 파일에서 특정 라인(단일 or 범위)을 삭제하고 '1.csv'로 저장하는 함수"""
    try:
        # 파일 읽기
        ...
        modified_file_path = f"{base_name}1.csv"
...
if __name__ == "__main__":
    # 명령줄 인자 파싱
    parser = argparse.ArgumentParser(description="TXT 파일에서 특정 라인을 삭제하고 '1.csv'로 저장합니다.")
